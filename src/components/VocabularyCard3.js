...
const VocabularyCard3 = ({ onClick, ...rest }) => {
  ...
  return (
    <div onClick={handleFlip} style={{ perspective: 5000, height: "28rem" }} className="relative mt-5 mr-14" {...rest}>
      <motion.div
        initial={false}
      ...
      >
        ...
        >
          ...
          <div className="flex flex-col space-y-1.5 mt-[60px]">
            <button className="bg-12b764 h-11 rounded-md" onClick={() => onClick()}>
              I can use this word in ielts!
            </button>
            <button className="bg-ffab0a h-11 rounded-md" onClick={() => onClick()}>
              I need to review this word!
            </button>
            <button className="bg-f04438 h-11 rounded-md" onClick={() => onClick()}>
