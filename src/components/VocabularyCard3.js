        ...
        >
          ...
          >
            ...
            <div className="flex flex-col lg:flex-row md:flex-col sm:flex-col">
              <span className="text-[32px] leading-5 font-medium mr-[106px] flex items-center justify-center lg:justify-center md:justify-start sm:justify-start">Rise</span>
